...
## Perbaikan v7
Homepage, kategori pilihan, produk pilihan, halaman semua produk, dan detail produk semuanya menggunakan Firestore. Semua script frontend memakai ES modules sehingga Firebase dapat di-load konsisten melalui Live Server/hosting.
